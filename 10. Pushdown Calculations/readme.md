...
![Table visual](./images/TableVisual1.PNG)
    ...
    <img width="400" src="./images/TableVisual1.png" alt="Table visual" />
...
![Query History](./images/QueryHistory1.PNG)
    <img width="800" src="./images/QueryHistory1.png" alt="Query history" /> 
...
![Table visual](./images/TableVisual2.PNG)
    <img width="400" src="./images/TableVisual2.png" alt="Table visual" /> 
...
![Query History](./images/QueryHistory2.PNG) 
    <img width="800" src="./images/QueryHistory2.png" alt="Query history" /> 
